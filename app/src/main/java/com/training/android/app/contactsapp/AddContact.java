...
public class AddContact extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnAddContact) {
            if (edtContactName.getText() != null && edtContactName.getText().toString().equals("")
                    && edtContactNumber.getText() != null && edtContactNumber.getText().toString().equals("")) {
                ...
                setResult(MainActivity.ADD_CONTACT_REQ_CODE, result);
                finish();
            }
